...
function examregistrar_booking_notify_newbooking($examregid, $context, $downloadurl, $record, $voucher) {
    ...
    $params = array('id'=>$newid, 'examid'=>$record->examid, 'userid'=>$record->userid);
...
function examregistrar_booking_clean_newbookings($examregid, $booking, $newid, $userid, $context) {
    global $DB, $USER;
